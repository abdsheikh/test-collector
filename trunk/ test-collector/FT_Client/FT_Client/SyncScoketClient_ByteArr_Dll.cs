...
namespace ClientSockets.Synchronous.UsingByteArray // SyncScoketClient_ByteArr_Dll
{
    ...
    {
        public static Socket server = null;//thiensuhack
        ...
        {
            get { return SynchronusClient_ByteArr.status; }
            set { SynchronusClient_ByteArr.status = value; }
        }
        ...
        /// <summary>
        /// thiensuhack added method 15.12.2011
        /// </summary>
...
//             }
            ...
            newFileName = newFileName + ".thiensuhack";
